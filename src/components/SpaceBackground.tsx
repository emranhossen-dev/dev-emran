...
export default function SpaceBackground() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-[#070d1e]">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[750px] h-[750px] rounded-full bg-[#4a2774]/35 blur-[160px] animate-pulse-glow" />
      <div className="absolute top-[25%] right-[-10%] w-[700px] h-[700px] rounded-full bg-[#1e3a8a]/45 blur-[170px] animate-pulse-glow" style={{ animationDelay: '3s' }} />
      <div className="absolute top-[55%] left-[-10%] w-[650px] h-[650px] rounded-full bg-[#581c87]/30 blur-[150px] animate-pulse-glow" style={{ animationDelay: '1.5s' }} />
      <div className="absolute bottom-[-10%] right-[5%] w-[800px] h-[800px] rounded-full bg-[#1d4ed8]/35 blur-[180px] animate-pulse-glow" style={{ animationDelay: '4.5s' }} />
      <div className="absolute top-[80%] left-[20%] w-[600px] h-[600px] rounded-full bg-[#0284c7]/25 blur-[140px] animate-pulse-glow" style={{ animationDelay: '2.5s' }} />

      {/* Floating Cosmic Star Particles */}
      ...
      {/* Cosmic Dot Grid Texture Layer */}
      <div className="absolute inset-0 bg-[radial-gradient(rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[size:32px_32px] opacity-70" />
